...
<body>
    ...
    <header>
        <div class="logo-container">
            <img src="{{ asset('images/inazuma/LogoPagina.jpg') }}" alt="Logo" class="logo-text">
        </div>
        
        <nav class="texto">
            <a href="{{ url('principal') }}" class="boton-menu">
                <img src="{{ asset('images/inazuma/Regiones.jpg') }}" alt="Regiones" class="region-text">
                <span>Regiones</span>
            </a>
            
            <a href="{{ url('personajes') }}" class="boton-menu">
                <img src="{{ asset('images/inazuma/Personajes.jpg') }}" alt="Personajes" class="region-text">
                <span>Personajes</span>
            </a>
            
            <a href="{{ url('inicio-sesion') }}" class="boton-menu">
                <img src="{{ asset('images/inazuma/Registro.jpg') }}" alt="Registro" class="region-text">
    ...
    <div class="contenedor-principal">
        ...
        <div class="galeria">
            @for ($i = 1; $i <= 8; $i++)
                <div class="galeria-item" onclick="abrirModal('{{ asset('images/inazuma/i' . $i . '.jpg') }}')">
                    <img src="{{ asset('images/inazuma/i' . $i . '.jpg') }}" alt="Inazuma {{ $i }}">
