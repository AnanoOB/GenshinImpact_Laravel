    ...
    <div class="contenedor-principal">
        ...
        <div class="carrusel-wrapper">
            <div class="carrusel" id="carrusel">
                <div class="carrusel-item activo"><img src="{{ asset('images/ifa.jpg') }}" alt="Imagen 1"></div>
                <div class="carrusel-item"><img src="{{ asset('images/neuvillette.jpg') }}" alt="Imagen 2"></div>
                <div class="carrusel-item"><img src="{{ asset('images/bennett.jpg') }}" alt="Imagen 3"></div>
                <div class="carrusel-item"><img src="{{ asset('images/lisa.jpg') }}" alt="Imagen 4"></div>
            </div>
